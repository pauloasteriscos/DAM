...
enum CommunicationScenario {
  arrivalHome(
    ...
    profiles: [UserProfileType.student, UserProfileType.host],
  ),
  bedroom(
  ...
  pets(
    ...
    description: 'Frases de aviso e cuidado relacionadas com animais da casa.',
    profiles: [UserProfileType.student, UserProfileType.host],
  ),
  transport(
  ...
  classroom(
    ...
    profiles: [UserProfileType.student, UserProfileType.teacher],
  ),
  presentation(
